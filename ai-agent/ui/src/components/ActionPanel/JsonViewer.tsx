...
const jsonPrettyTheme = {
  main: 'margin:0;background:transparent;color:var(--json-syntax-fg);font-family:var(--font-mono);font-size:13px;line-height:1.75;letter-spacing:-0.015em;white-space:pre-wrap;word-break:break-word;overflow-wrap:anywhere;tab-size:2',
