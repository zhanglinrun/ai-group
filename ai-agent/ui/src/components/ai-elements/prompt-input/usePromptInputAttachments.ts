 ...
 */
export function usePromptInputAttachmentState(options: UsePromptInputAttachmentStateOptions) {
  const { accept, maxFiles, maxFileSize, onError, onAttachmentsAdded } = options;
