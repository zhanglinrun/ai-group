...
import { convertBlobUrlToDataUrl } from './attachments';
import {
...
export const PromptInput = ({
  ...
  const remove = usingProvider ? controller.attachments.remove : localAttachments.remove;
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = (event) => {
    ...
    const prepareFiles = convertBlobUrlsOnSubmit
      ...
      : Promise.resolve(files.map(({ id, ...item }) => item));
