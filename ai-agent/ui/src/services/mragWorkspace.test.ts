...
describe('mragWorkspace service utils', () => {
  ...
  it('能在 preview / download 之间互相推导地址', () => {
    expect(resolveWorkspacePreviewUrl('http://127.0.0.1:1601/download/req/demo.pdf')).toBe(
      'http://127.0.0.1:1601/preview/req/demo.pdf',
    );
    expect(resolveWorkspaceDownloadUrl('http://127.0.0.1:1601/preview/req/demo.pdf')).toBe(
      'http://127.0.0.1:1601/download/req/demo.pdf',
    );
  });
