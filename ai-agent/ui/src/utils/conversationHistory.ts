...
export function toConversationHistoryTitle(
  detail?: Pick<ConversationHistoryDetail, 'title' | 'sessionId'> | null,
) {
  if (!detail) {
    return '新对话';
  }
...
function syncConclusionFromEventData(currentChat: CHAT.ChatItem, eventData: MESSAGE.EventData) {
