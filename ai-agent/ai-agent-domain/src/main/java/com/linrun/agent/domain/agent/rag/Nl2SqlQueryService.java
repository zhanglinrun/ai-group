...
import com.linrun.agent.domain.agent.reactor.data.dto.ChatQueryColumn;
import com.linrun.agent.domain.agent.reactor.data.dto.ChatQueryData;
import com.linrun.agent.domain.agent.reactor.data.dto.ChatQueryFilter;
...
import com.linrun.agent.domain.agent.reactor.data.dto.NL2SQLResult;
import com.linrun.agent.domain.agent.reactor.data.model.ComparisonType;
import com.linrun.agent.domain.agent.reactor.data.model.DataOrderBy;
import com.linrun.agent.domain.agent.reactor.data.model.ModelColumn;
import com.linrun.agent.domain.agent.reactor.data.model.SqlModel;
import com.linrun.agent.domain.agent.reactor.data.model.StandardColumnType;
import com.linrun.agent.domain.agent.reactor.data.model.WhereCondition;
import com.linrun.agent.domain.agent.reactor.data.sql.SqlParserUtils;
import com.linrun.agent.domain.agent.reactor.model.response.ChatDataMessage;
