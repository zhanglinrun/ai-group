...
import com.linrun.agent.infrastructure.tooloutput.ToolOutputReaderImpl;
import com.linrun.agent.infrastructure.tooloutput.ToolOutputWriterImpl;
...
public class ToolOutputArtifactBackfillTest {
    ...
    public void shouldHydrateFileRefsFromArtifactLedgerWhenReadingRichOutput() {
        ...
        IToolOutputTodoWriteDao todoWriteDao = Mockito.mock(IToolOutputTodoWriteDao.class);
    ...
    public void shouldFallbackToRunAndToolCallWhenDirectLookupHasNoInvocationId() {
        ...
        Mockito.when(todoWriteDao.queryByRequestToolCall(Mockito.anyString(), Mockito.anyString())).thenReturn(null);
