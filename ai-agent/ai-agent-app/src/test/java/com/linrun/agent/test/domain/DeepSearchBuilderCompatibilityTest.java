...
import com.linrun.agent.domain.agent.runtime.tool.common.DeepSearchStructuredResultBuilder;
...
public class DeepSearchBuilderCompatibilityTest {
    ...
    private static final class DeepSearchCompatibilityClassLoader extends URLClassLoader {
        ...
        private static final Set<String> BLOCKED_CLASS_NAMES = new LinkedHashSet<>(List.of(
                "com.linrun.agent.domain.agent.ledger.model.tooloutput.DeepSearchStage$DeepSearchStageBuilder",
                "com.linrun.agent.domain.agent.ledger.model.tooloutput.DeepSearchToolOutput$DeepSearchToolOutputBuilder",
                "com.linrun.agent.domain.agent.ledger.model.tooloutput.DeepSearchQueryResult$DeepSearchQueryResultBuilder",
                "com.linrun.agent.domain.agent.ledger.model.tooloutput.DeepSearchDoc$DeepSearchDocBuilder"
        ));

        private static final List<String> CHILD_FIRST_PREFIXES = List.of(
                "com.linrun.agent.domain.agent.runtime.tool.common.DeepSearchStructuredResultBuilder",
                "com.linrun.agent.domain.agent.runtime.dto.DeepSearchrResponse",
                "com.linrun.agent.domain.agent.ledger.model.tooloutput.DeepSearch"
        );
