package com.aigroup.groupbuy.types.enums;
...
public enum ResponseCode {
    ...
    E0103("E0103", "当前用户已有进行中的拼团，请先完成或取消后再参加"),
    E0104("E0104", "不存在的外部交易单号或用户已退单"),
    E0105("E0105", "SC渠道黑名单拦截"),
    E0106("E0106", "订单交易时间不在拼团有效时间范围内"),
    // info kept in English: this module compiles with ISO-8859-1, Chinese literals would garble at runtime
    E0107("E0107", "group buy team is finalized (complete/fail), order can not be settled"),
