...
public interface IGroupBuyMarketService {
    ...
    @POST("api/v1/gbm/trade/demo_finalize_market_pay_order")
    Call<Response<String>> finalizeDemoMarketPayOrder(@Body DemoFinalizeMarketPayOrderRequestDTO requestDTO);
