...
export const productList = [
  ...
  },
  {
    ...
    img: 'icon-diannao',
    type: 'html',
    placeholder: '熊博士agent会完成你的任务并以 HTML 网页方式输出报告',
    color: 'text-[#29CC29]',
  },
  {
    name: '文档模式',
    img: 'icon-wendang',
    type: 'docs',
    placeholder: '熊博士agent会完成你的任务并以 markdown 格式输出文档',
    color: 'text-[#4040FF]',
  },
  {
    name: 'PPT模式',
    img: 'icon-ppt',
    type: 'ppt',
    placeholder: '熊博士agent会完成你的任务并以 PPT 方式输出结论',
    color: 'text-[#FF860D]',
  },
  {
    name: '表格模式',
    img: 'icon-biaoge',
    type: 'table',
    placeholder: '熊博士agent会完成你的任务并以表格格式输出结论',
    color: 'text-[#FF3333]',
  },
];
