...
export function shouldBootstrapKnowledgeBases(
  ...
  return Boolean(currentToolBaseUrl) && lastBootstrappedToolBaseUrl !== currentToolBaseUrl;
}

export function shouldPollKnowledgeBaseFiles(files: Array<Pick<KnowledgeBaseFile, 'fileStatus'>>) {
