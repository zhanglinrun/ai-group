...
原始证据见 [`README.md`](README.md)、[`smoke-agent-memory.ps1`](../dev-ops/smoke-agent-memory.ps1)、[`test_mcp_servers.py`](../../ai-agent/reactor-tool/tests/test_mcp_servers.py)、[`McpStdioInteropTest.java`](../../ai-agent/ai-agent-app/src/test/java/com/linrun/agent/test/spring/ai/McpStdioInteropTest.java)、[`McpStreamableHttpSupportTest.java`](../../ai-agent/ai-agent-app/src/test/java/com/linrun/agent/test/spring/ai/McpStreamableHttpSupportTest.java) 和 [`reports/group-load-benchmark.json`](reports/group-load-benchmark.json)。
